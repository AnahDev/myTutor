        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-2 sm:-my-px sm:ms-8 sm:flex items-center">
                    ...
                    <x-nav-link :href="route('comunidad')" :active="request()->routeIs('comuniad')"
                        class="inline-flex items-center px-4 py-2 text-sm font-medium rounded-xl transition-all duration-300 {{ request()->routeIs('comunidad') ? 'bg-gradient-to-r from-indigo-500 to-blue-500 text-white shadow-lg' : 'text-gray-700 hover:text-indigo-600 hover:bg-white/60 hover:shadow-md' }}">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z">
                            </path>
                    ...
                    {{-- qr --}}
                    <x-nav-link :href="route('qr.generate')" :active="request()->routeIs('qr.generate')"
                        class="inline-flex items-center px-4 py-2 text-sm font-medium rounded-xl transition-all duration-300 {{ request()->routeIs('qr.generate') ? 'bg-gradient-to-r from-indigo-500 to-blue-500 text-white shadow-lg' : 'text-gray-700 hover:text-indigo-600 hover:bg-white/60 hover:shadow-md' }}">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z">
                            </path>
